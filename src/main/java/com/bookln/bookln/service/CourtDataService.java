...
public class CourtDataService {
    ...
    public CourtDataService() {
        ...
        courtArray[0] = new Court("Power Hitters", "North Nazimabad", "images/PowerHitters.jpg", "923333164366");
        courtArray[1] = new Court("Groove Arena", "Gulistan-e-Johar", "images/Groove.PNG", "923153423429");
        courtArray[2] = new Court("Fireball Arena", "A-410, Gulshan-e-Iqbal", "images/FIREBALL.jpg", "923073833225");
        courtArray[3] = new Court("Powerplay", "Block 10 Gulshan-e-Iqbal", "images/powerplay.jpg", "923193497605");
        courtArray[4] = new Court("The Sports Club", "Block 15 Gulistan-e-Johar", "images/thesportsclub.jpg",
                "923167090600");
        courtArray[5] = new Court("Elite Indoor", "Federal B Area Block 8 Gulberg Town", "images/EliteIndoor.jpg",
                "923352361184");
        courtArray[6] = new Court("Futflick", "Shaheed-e-Millat Rd, Darul Aman Society P.E.C.H.S", "images/FUTFLIX.PNG",
                "923003928092");
        ...
        courtArray[9] = new Court("Aranzee Arena", "F.B Area Block 6", "images/AranzeeArena.jpg", "923332226424");
        ...
        courtArray[12] = new Court("Sports Spirit", "Gulshan-e-iqbal block 4-A ,Plot No A-1R", "images/sportspirit.jpg",
                "923238283392");
        ...
        courtArray[20] = new Court("The Edge", "Abul Hasan Isphahani Rd,Block 4 Gulshan-e-Iqbal", "images/TheEdge.jpg",
                "923390507050");
        ...
        courtArray[22] = new Court("Dribbling Arena", "Block Q North Nazimabad Town", "images/DribblingArena.jpg",
                "923700028410");
        ...
        courtArray[27] = new Court("Battlefield by Sports Club", "Block 14 Gulistan-e-Johar", "images/Battlefield.jpg",
                "923193008828");
        ...
        courtArray[31] = new Court("Playdium Indoor", "Block 12 Gulistan-e-Johar", "images/playdiumindoor.jpg",
                "923361240246");
        courtArray[32] = new Court("Dreamers Arena", "Federal B Area Block 7 Gulberg Town", "images/dreamer arena.PNG",
                "923327017017");
        courtArray[33] = new Court("Elixir Arena", "Street 1, Block G North Nazimabad Town", "images/Elixir.jpg",
                "923394120006");
        ...
        courtArray[36] = new Court("Urban Turf", "Siraj ud-Daulah Rd, opp. Naheed super market", "images/UrbanTurf.jpg",
                "923142551179");
        ...
        courtArray[38] = new Court("The Smash", "C-183, Block I North Nazimabad Town", "images/smashh.jpg",
                "923062515026");
        courtArray[39] = new Court("Royal Arena for Indoor Sports", "Sector F Askari X", "images/ROYALARENA.jpg",
                "923004767119");
        ...
        courtArray[42] = new Court("Big Bash Boom The Indoor Cricket Arena",
                "58-A Multan Rd, near ShahFreed Darbar, Sabzazar Block A", "images/zbigbash.jpg", "923270771157");
        ...
        courtArray[45] = new Court("MHA Sports Arena", "Zeenat Block Allama Iqbal Town, Lahore", "images/zmha.jpg",
                "923232333212");
        courtArray[46] = new Court("Legacy Arena Iqbal Town Lahore",
                "Bari Studios, Zeenat Block Allama Iqbal Town, Lahore", "images/zlegendsarenalahore.jpg",
                "923364422883");
        courtArray[47] = new Court("Apex Sports Arena", "Opposite Khalid Block, Safari Valley, Japan Road Bahria Town",
        ...
        courtArray[50] = new Court("Stumps Rooftop", "Dubai Plaza ,6th Road Chowk,Rawalpindi", "images/zzstumps.jpg",
                "923037886777");
        courtArray[51] = new Court("CricUp - Rooftop Cricket", "Rawalpindi", "images/ycricup.jpg", "923312742870");
        courtArray[52] = new Court("Game On", "C-278 Block 14 Gulistan E Jauhar Karachi", "images/ygameon.jpg",
                "923345252003");
        courtArray[53] = new Court("Soan Garden Indoor Cricket Field", "Block D Islamabad", "images/ysoangarden.jpg",
                "923065417404");
        courtArray[54] = new Court("Sports X", "Street 698, Near Dr. AQ Khan School, 513/3, Islamabad",
                "images/ysportsx.jpg", "923361336133");
        courtArray[55] = new Court("Junoon Indoor", "Sahiwal, Punjab", "images/xjunoonindoor.jpg", "923361336133");
        courtArray[56] = new Court("Play Max", "Bharia Town, Lahore", "images/xplaymax.jpg", "923361336133");
        courtArray[57] = new Court("PIPS Sports Arena", "Adjacent PIPS Boys School,Gujranwala", "images/xpip.jpg",
                "923105777666");
        courtArray[58] = new Court("Starla Sports", "Opposite Starla Factory/ Sialkot law college",
                "images/xstarla.jpg", "923300346346");
        courtArray[59] = new Court("Legends Field", "D-3 Sector 16 A Buffer Zone", "images/LF.jpg", "923008250767");
        ...
        courtArray[62] = new Court("Padel Arena", "K21 Club Model Town, Lahore", "images/PadelArena.jpeg",
                "923413911999");
        courtArray[63] = new Court("The Padel Pit", "Islamabad, Pakistan", "images/padelpit.jpeg", "923302271227");
